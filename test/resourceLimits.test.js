...
test('loadResourceLimits reads valid overrides from their exact env keys', () => {
  assert.deepEqual(loadResourceLimits({
    ...
    CATAPI_MAX_HISTORY_CHARS: '5',
    CATAPI_MAX_STREAM_BUFFER_CHARS: '6',
    CATAPI_UPSTREAM_TIMEOUT_MS: '7',
    CATAPI_MAX_RECENT_ACTIVITY: '8',
    CATAPI_MAX_LOG_BYTES: '9',
    CATAPI_RETAINED_LOG_FILES: '10',
    CATAPI_MAX_CLAUDE_SESSION_FILES: '11',
  }), {
    maxAgentSessions: 1,
    agentSessionTtlMs: 2,
    ...
    maxRequestBytes: 4,
    maxHistoryChars: 5,
    maxStreamBufferChars: 6,
    upstreamTimeoutMs: 7,
    maxRecentActivity: 8,
    maxLogBytes: 9,
    retainedLogFiles: 10,
    maxClaudeSessionFiles: 11,
  });
});
