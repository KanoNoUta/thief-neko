...
| 平台 | 文件 |
| --- | --- |
| Windows x64 | `Thief-Neko-v0.2.2-win-x64.zip` |
| Linux x64 | `Thief-Neko-v0.2.2-linux-x64.tar.gz` |
...
```bash
tar -xzf Thief-Neko-v0.2.2-linux-x64.tar.gz
cd Thief-Neko-v0.2.2-linux-x64
